...
$pageTitle = 'PIN Result Access - ' . SCHOOL_NAME;
$db = getDB();
$error = '';
$showResult = false;
$student = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($admissionNo) || empty($pin)) {
        ...
        $stmt = $db->prepare("
            SELECT s.id, s.class_id, s.admission_no, u.first_name, u.last_name, u.avatar,
        ...
        if (!$student) {
            ...
            if (!$pinRow) {
                ...
                if (validateResultPin($db, $pin, $student['id'], $pinRow['session_id'], $pinRow['term_id'])) {
                    $_SESSION['pin_access'][$student['id']] = ['session_id' => $pinRow['session_id'], 'term_id' => $pinRow['term_id'], 'pin' => $pin];
...
$verifiedStudentId = $_SESSION['pin_access'] ?? [];
$resumePin = null;
if (!empty($verifiedStudentId) && !$showResult) {
    $sid = array_key_first($verifiedStudentId);
    $access = $verifiedStudentId[$sid];
    $resumePin = $access;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .pin-container { max-width: 500px; margin: 0 auto; }
        .report-container { max-width: 1000px; margin: 0 auto; }
        .card { border: none; border-radius: 16px; }
        .gold-text { color: #D4AF37; }
        @media print {
            .no-print, .pin-container { display: none !important; }
    ...
    <div class="container">
        ...
        <div class="pin-container">
            <div class="text-center mb-4">
                ...
                <p class="text-white-50">Access your result using PIN</p>
            </div>
            ...
            <div class="card shadow">
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info py-2">
                        <i class="fas fa-info-circle me-1"></i>You have an active session. 
                        <a href="?clear=1" class="float-end text-danger"><i class="fas fa-times"></i></a>
                    </div>
                    <?php endif; ?>
            ...
            <div class="text-center mt-3">
                <a href="<?= BASE_URL ?>/auth/login.php" class="text-white-50 small">
        ...
        <div class="report-container">
            <div class="text-center mb-3 no-print">
                ...
                <a href="<?= BASE_URL ?>/student/results/pin.php" class="btn btn-outline-light btn-sm ms-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-md-4 text-center">
                            <?php if ($pinCode): ?>
                            <img src="https://chart.googleapis.com/chart?chs=120x120&cht=qr&chl=<?= urlencode(BASE_URL . '/auth/result-verify.php?pin=' . urlencode($pinCode) . '&sid=' . $sessionId . '&tid=' . $termId . '&stid=' . $student['id']) ?>" alt="QR Code">
                            <p class="small text-muted mt-1 mb-0">Scan to verify</p>
                            <?php endif; ?>
                        </div>
                        <div class="col-md-4 text-center">
                            <?php if ($promotion): ?>
