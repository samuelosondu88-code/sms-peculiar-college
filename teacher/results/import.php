...
$selectedTerm = (int)($_GET['term_id'] ?? ($currentTerm['id'] ?? 0));
...
");
$mySubjects->execute([$teacherId, $selectedSession]);
$mySubjects = $mySubjects->fetchAll();

$myClasses = [];
foreach ($mySubjects as $subj) {
    $key = $subj['class_id'];
    if (!isset($myClasses[$key])) {
        $myClasses[$key] = ['id' => $subj['class_id'], 'name' => $subj['class_name'], 'section' => $subj['section']];
    }
}
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold mb-0"><i class="fas fa-file-import me-2 text-success"></i>Import Scores (CSV)</h4>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="alert alert-info py-2">
            ...
            CSV columns: <strong>admission_no, assignment1, assignment2, test1, test2, exam, project</strong>.
        </div>
        <form method="POST" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <select name="subject_id" class="form-select" required>
                    ...
                    <?php if (!$selectedClass || $sub['class_id'] == $selectedClass): ?>
    ...
    <div class="card-body p-0">
        <form method="POST">
            ...
            <div class="card-footer text-end">
                <a href="<?= BASE_URL ?>/teacher/results/import.php" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i>Back</a>
